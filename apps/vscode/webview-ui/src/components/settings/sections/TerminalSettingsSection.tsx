				...
				<div className="mb-5" id="terminal-settings-section">
					{isVsCodePlatform && (
						<div className="mb-4">
							...
							<p className="text-xs text-[var(--vscode-descriptionForeground)] mt-1">
								Choose whether PlinyCode runs commands in the VS Code terminal or a background process.
							</p>
						</div>
					)}
						...
						<>
							<div className="mb-4">
								...
								<p className="text-xs text-(--vscode-descriptionForeground)">
									Set how long PlinyCode waits for shell integration to activate before executing commands.
							...
							<div className="mb-4">
								...
								<p className="text-xs text-(--vscode-descriptionForeground)">
									When enabled, PlinyCode will reuse existing terminal windows that aren't in the current
					...
					<div className="mb-4">
						...
						<p className="text-xs text-(--vscode-descriptionForeground) mt-1">
							Select the default terminal PlinyCode will use. 'Default' uses your VSCode global setting.
						</p>
					</div>
