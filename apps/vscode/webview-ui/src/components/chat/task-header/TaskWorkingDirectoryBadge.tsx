 ...
 * CLI or from another workspace). PlinyCode reads, edits, and runs commands in
	...
	return (
		<Tooltip>
			<TooltipContent className="max-w-xs" side="bottom">
				This task's working directory is {cwd}, which is outside the current workspace. PlinyCode reads and edits files
