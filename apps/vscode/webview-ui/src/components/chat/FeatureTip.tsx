...
const FEATURE_TIPS: FeatureTipItem[] = [
	{
		text: "Add a .clinerules file to your project root to give PlinyCode project-specific instructions.",
	},
	{
		text: "Switch to Plan Mode to discuss and plan an approach before PlinyCode takes action.",
	},
	{
		text: "Use @ in the chat input to add files, folders, or URLs as context for your task.",
	},
	{
		text: "Set up MCP Servers to give PlinyCode access to external tools and APIs.",
	},
	{
		text: "PlinyCode creates checkpoints after changes — you can always restore to a previous state.",
	},
	{
	...
	{
		text: "Use the quote button to select text from PlinyCode's response and reference it in your reply.",
	},
	{
		text: "You can drag and drop images into the chat to share screenshots with PlinyCode.",
	},
	{
 ...
 * Appears after a brief delay and cycles through tips while PlinyCode is thinking.
 */
