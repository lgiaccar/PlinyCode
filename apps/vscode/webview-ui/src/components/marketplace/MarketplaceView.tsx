...
const PRIMITIVES: PrimitiveConfig[] = [
	{
		...
		description: (
			<>
				Reusable instruction sets that PlinyCode loads on demand for specific tasks, without staying in context for
	...
	},
	{
		...
		description: (
			<>
				Connect PlinyCode to external APIs, local tools, and hosted services through{" "}
