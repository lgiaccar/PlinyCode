...
const ClineRulesToggleModal: React.FC = () => {
	...
	const toggleRule = (isGlobal: boolean, rulePath: string, enabled: boolean) => {
		FileServiceClient.toggleClineRule(
			...
			.catch((error) => {
				console.error("Error toggling PlinyCode rule:", error)
			})
	}
					...
					<div className="flex-shrink-0 px-3 pt-2">
						...
						<div className="text-xs text-description mb-4">
							{currentView === "rules" ? (
								...
								<p>
									Workflows allow you to define a series of steps to guide PlinyCode through a repetitive set of
								...
								<p>
									Hooks allow you to execute custom scripts at specific points in PlinyCode's execution
